...
#   https://github.com/rupor-github/win-gpg-agent/blob/main/docs/win-gpg-agent-relay

# For debugging startup problems uncomment next line
# exec 2> >(tee -a -i "/var/log/win-gpg-relay.log")
...
SORELAY_BIN="${HOME}/WinHome/scoop/apps/win-gpg-agent/current/sorelay.exe"
