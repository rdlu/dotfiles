...
function __fish_probe_rs_global_optspecs
	string join \n log-file= log-to-folder r/report= h/help V/version
end
...
complete -c probe-rs -n "__fish_probe_rs_needs_command" -l log-file -d 'Location for log file' -r -F
complete -c probe-rs -n "__fish_probe_rs_needs_command" -s r -l report -r -F
complete -c probe-rs -n "__fish_probe_rs_needs_command" -l log-to-folder -d 'Enable logging to the default folder. This option is ignored if `--log-file` is specified'
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand dap-server" -l log-file -d 'Location for log file' -r -F
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand dap-server" -l log-to-folder -d 'Enable logging to the default folder. This option is ignored if `--log-file` is specified'
complete -c probe-rs -n "__fish_probe_rs_using_subcommand dap-server" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c probe-rs -n "__fish_probe_rs_using_subcommand list" -l log-file -d 'Location for log file' -r -F
complete -c probe-rs -n "__fish_probe_rs_using_subcommand list" -s r -l report -r -F
complete -c probe-rs -n "__fish_probe_rs_using_subcommand list" -l log-to-folder -d 'Enable logging to the default folder. This option is ignored if `--log-file` is specified'
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand info" -l log-file -d 'Location for log file' -r -F
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand info" -l log-to-folder -d 'Enable logging to the default folder. This option is ignored if `--log-file` is specified'
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand reset" -l log-file -d 'Location for log file' -r -F
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand reset" -l log-to-folder -d 'Enable logging to the default folder. This option is ignored if `--log-file` is specified'
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand gdb" -l log-file -d 'Location for log file' -r -F
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand gdb" -l log-to-folder -d 'Enable logging to the default folder. This option is ignored if `--log-file` is specified'
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand debug" -l log-file -d 'Location for log file' -r -F
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand debug" -l log-to-folder -d 'Enable logging to the default folder. This option is ignored if `--log-file` is specified'
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand download" -l idf-bootloader -d 'The idf bootloader path' -r -F
complete -c probe-rs -n "__fish_probe_rs_using_subcommand download" -l idf-partition-table -d 'The idf partition table path' -r -F
complete -c probe-rs -n "__fish_probe_rs_using_subcommand download" -l log-file -d 'Location for log file' -r -F
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand download" -l log-to-folder -d 'Enable logging to the default folder. This option is ignored if `--log-file` is specified'
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand verify" -l idf-bootloader -d 'The idf bootloader path' -r -F
complete -c probe-rs -n "__fish_probe_rs_using_subcommand verify" -l idf-partition-table -d 'The idf partition table path' -r -F
complete -c probe-rs -n "__fish_probe_rs_using_subcommand verify" -l log-file -d 'Location for log file' -r -F
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand verify" -l log-to-folder -d 'Enable logging to the default folder. This option is ignored if `--log-file` is specified'
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand erase" -l log-file -d 'Location for log file' -r -F
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand erase" -l log-to-folder -d 'Enable logging to the default folder. This option is ignored if `--log-file` is specified'
complete -c probe-rs -n "__fish_probe_rs_using_subcommand erase" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c probe-rs -n "__fish_probe_rs_using_subcommand run" -l format -d 'Configure formatting of the test report output' -r -f -a "{pretty\t'One line per test. Output for humans. (default)',terse\t'One character per test. Usefull for test suites with many tests',json\t'Json output'}"
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand run" -l idf-bootloader -d 'The idf bootloader path' -r -F
complete -c probe-rs -n "__fish_probe_rs_using_subcommand run" -l idf-partition-table -d 'The idf partition table path' -r -F
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand run" -l log-file -d 'Location for log file' -r -F
complete -c probe-rs -n "__fish_probe_rs_using_subcommand run" -s r -l report -r -F
complete -c probe-rs -n "__fish_probe_rs_using_subcommand run" -l catch-reset -d 'Enable reset vector catch if its supported on the target'
complete -c probe-rs -n "__fish_probe_rs_using_subcommand run" -l catch-hardfault -d 'Enable hardfault vector catch if its supported on the target'
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand run" -l log-to-folder -d 'Enable logging to the default folder. This option is ignored if `--log-file` is specified'
complete -c probe-rs -n "__fish_probe_rs_using_subcommand run" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c probe-rs -n "__fish_probe_rs_using_subcommand attach" -l format -d 'Configure formatting of the test report output' -r -f -a "{pretty\t'One line per test. Output for humans. (default)',terse\t'One character per test. Usefull for test suites with many tests',json\t'Json output'}"
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand attach" -l idf-bootloader -d 'The idf bootloader path' -r -F
complete -c probe-rs -n "__fish_probe_rs_using_subcommand attach" -l idf-partition-table -d 'The idf partition table path' -r -F
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand attach" -l log-file -d 'Location for log file' -r -F
complete -c probe-rs -n "__fish_probe_rs_using_subcommand attach" -s r -l report -r -F
complete -c probe-rs -n "__fish_probe_rs_using_subcommand attach" -l catch-reset -d 'Enable reset vector catch if its supported on the target'
complete -c probe-rs -n "__fish_probe_rs_using_subcommand attach" -l catch-hardfault -d 'Enable hardfault vector catch if its supported on the target'
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand attach" -l log-to-folder -d 'Enable logging to the default folder. This option is ignored if `--log-file` is specified'
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand trace" -l log-file -d 'Location for log file' -r -F
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand trace" -l log-to-folder -d 'Enable logging to the default folder. This option is ignored if `--log-file` is specified'
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand itm; and not __fish_seen_subcommand_from memory swo help" -l log-file -d 'Location for log file' -r -F
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand itm; and not __fish_seen_subcommand_from memory swo help" -l log-to-folder -d 'Enable logging to the default folder. This option is ignored if `--log-file` is specified'
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand itm; and __fish_seen_subcommand_from memory" -l log-file -d 'Location for log file' -r -F
complete -c probe-rs -n "__fish_probe_rs_using_subcommand itm; and __fish_seen_subcommand_from memory" -s r -l report -r -F
complete -c probe-rs -n "__fish_probe_rs_using_subcommand itm; and __fish_seen_subcommand_from memory" -l log-to-folder -d 'Enable logging to the default folder. This option is ignored if `--log-file` is specified'
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand itm; and __fish_seen_subcommand_from swo" -l log-file -d 'Location for log file' -r -F
complete -c probe-rs -n "__fish_probe_rs_using_subcommand itm; and __fish_seen_subcommand_from swo" -s r -l report -r -F
complete -c probe-rs -n "__fish_probe_rs_using_subcommand itm; and __fish_seen_subcommand_from swo" -l log-to-folder -d 'Enable logging to the default folder. This option is ignored if `--log-file` is specified'
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand chip; and not __fish_seen_subcommand_from list info help" -l log-file -d 'Location for log file' -r -F
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand chip; and not __fish_seen_subcommand_from list info help" -l log-to-folder -d 'Enable logging to the default folder. This option is ignored if `--log-file` is specified'
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand chip; and __fish_seen_subcommand_from list" -l log-file -d 'Location for log file' -r -F
complete -c probe-rs -n "__fish_probe_rs_using_subcommand chip; and __fish_seen_subcommand_from list" -s r -l report -r -F
complete -c probe-rs -n "__fish_probe_rs_using_subcommand chip; and __fish_seen_subcommand_from list" -l log-to-folder -d 'Enable logging to the default folder. This option is ignored if `--log-file` is specified'
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand chip; and __fish_seen_subcommand_from info" -l log-file -d 'Location for log file' -r -F
complete -c probe-rs -n "__fish_probe_rs_using_subcommand chip; and __fish_seen_subcommand_from info" -s r -l report -r -F
complete -c probe-rs -n "__fish_probe_rs_using_subcommand chip; and __fish_seen_subcommand_from info" -l log-to-folder -d 'Enable logging to the default folder. This option is ignored if `--log-file` is specified'
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand benchmark" -l log-file -d 'Location for log file' -r -F
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand benchmark" -l log-to-folder -d 'Enable logging to the default folder. This option is ignored if `--log-file` is specified'
complete -c probe-rs -n "__fish_probe_rs_using_subcommand benchmark" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l format -d 'Configure formatting of the test report output' -r -f -a "{pretty\t'One line per test. Output for humans. (default)',terse\t'One character per test. Usefull for test suites with many tests',json\t'Json output'}"
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l skip-test -d 'Skip tests whose names contain FILTER (this flag can be used multiple times)' -r
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -s Z -d 'No-op, ignored. Flag only exists for CLI compatibility with libtest' -r
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l chip -r
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l chip-description-path -r -F
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l protocol -d 'Protocol used to connect to chip. Possible options: [swd, jtag]' -r
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l probe -d 'Use this flag to select a specific probe in the list' -r
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l speed -d 'The protocol speed in kHz' -r
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l flash-layout -d 'Requests the flash builder to output the layout into the given file in SVG format' -r
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l binary-format -d 'If a format is provided, use it. If a target has a preferred format, we use that. Finally, if neither of the above cases are true, we default to ELF' -r
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l base-address -d 'The address in memory where the binary will be put at. This is only considered when `bin` is selected as the format' -r
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l skip -d 'The number of bytes to skip at the start of the binary file. This is only considered when `bin` is selected as the format' -r
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l idf-bootloader -d 'The idf bootloader path' -r -F
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l idf-partition-table -d 'The idf partition table path' -r -F
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l log-format -d 'The format string to use when printing defmt encoded log messages from the target' -r
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l duration -d 'Duration of profile in seconds' -r
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l core -d 'Which core to profile' -r
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l limit -d 'Limit the number of entries to output' -r
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l log-file -d 'Location for log file' -r -F
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -s r -l report -r -F
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l catch-reset -d 'Enable reset vector catch if its supported on the target'
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l catch-hardfault -d 'Enable hardfault vector catch if its supported on the target'
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l list -d 'List all tests instead of executing them'
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l exact -d 'If set, filters are matched exactly rather than by substring'
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l nocapture
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l show-output -d 'No-op, ignored. libtest-mimic does not currently capture stdout'
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l non-interactive -d 'Disable interactive probe selection'
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l connect-under-reset -d 'Use this flag to assert the nreset & ntrst pins during attaching the probe to the chip'
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l dry-run
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l allow-erase-all -d 'Use this flag to allow all memory, including security keys and 3rd party firmware, to be erased even when it has read-only protection'
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l disable-progressbars
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l disable-double-buffering -d 'Use this flag to disable double-buffering when downloading flash data. If download fails during programming with timeout errors, try this option'
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l restore-unwritten -d 'Enable this flag to restore all bytes erased in the sector erase but not overwritten by any page'
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l preverify -d 'Before flashing, read back all the flashed data to skip flashing if the device is up to date'
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l verify -d 'After flashing, read back all the flashed data to verify it has been written correctly'
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l always-print-stacktrace -d 'Always print the stacktrace on ctrl + c'
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l chip-erase -d 'Whether to erase the entire chip before downloading'
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l no-location -d 'Suppress filename and line number information from the rtt log'
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l rtt-scan-memory -d 'Scan the memory to find the RTT control block'
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l flash -d 'Flash the ELF before profiling'
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l line-info -d 'Print file and line info for each entry'
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -l log-to-folder -d 'Enable logging to the default folder. This option is ignored if `--log-file` is specified'
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -a "naive" -d 'Naive, Halt -> Read PC -> Resume profiler'
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -a "itm" -d 'Use the Itm port to profile the chip (ARM only)'
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and not __fish_seen_subcommand_from naive itm help" -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and __fish_seen_subcommand_from naive" -l log-file -d 'Location for log file' -r -F
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and __fish_seen_subcommand_from naive" -s r -l report -r -F
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and __fish_seen_subcommand_from naive" -l log-to-folder -d 'Enable logging to the default folder. This option is ignored if `--log-file` is specified'
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and __fish_seen_subcommand_from itm" -l log-file -d 'Location for log file' -r -F
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and __fish_seen_subcommand_from itm" -s r -l report -r -F
complete -c probe-rs -n "__fish_probe_rs_using_subcommand profile; and __fish_seen_subcommand_from itm" -l log-to-folder -d 'Enable logging to the default folder. This option is ignored if `--log-file` is specified'
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand read" -l log-file -d 'Location for log file' -r -F
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand read" -l log-to-folder -d 'Enable logging to the default folder. This option is ignored if `--log-file` is specified'
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand write" -l log-file -d 'Location for log file' -r -F
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand write" -l log-to-folder -d 'Enable logging to the default folder. This option is ignored if `--log-file` is specified'
complete -c probe-rs -n "__fish_probe_rs_using_subcommand write" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c probe-rs -n "__fish_probe_rs_using_subcommand complete; and not __fish_seen_subcommand_from install probe-list chip-list help" -l shell -r -f -a "{bash\t'',elvish\t'',fish\t'',powershell\t'',zsh\t''}"
complete -c probe-rs -n "__fish_probe_rs_using_subcommand complete; and not __fish_seen_subcommand_from install probe-list chip-list help" -l log-file -d 'Location for log file' -r -F
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand complete; and not __fish_seen_subcommand_from install probe-list chip-list help" -l log-to-folder -d 'Enable logging to the default folder. This option is ignored if `--log-file` is specified'
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand complete; and __fish_seen_subcommand_from install" -l log-file -d 'Location for log file' -r -F
complete -c probe-rs -n "__fish_probe_rs_using_subcommand complete; and __fish_seen_subcommand_from install" -s r -l report -r -F
complete -c probe-rs -n "__fish_probe_rs_using_subcommand complete; and __fish_seen_subcommand_from install" -l log-to-folder -d 'Enable logging to the default folder. This option is ignored if `--log-file` is specified'
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand complete; and __fish_seen_subcommand_from probe-list" -l log-file -d 'Location for log file' -r -F
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand complete; and __fish_seen_subcommand_from probe-list" -l log-to-folder -d 'Enable logging to the default folder. This option is ignored if `--log-file` is specified'
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand complete; and __fish_seen_subcommand_from chip-list" -l log-file -d 'Location for log file' -r -F
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand complete; and __fish_seen_subcommand_from chip-list" -l log-to-folder -d 'Enable logging to the default folder. This option is ignored if `--log-file` is specified'
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand mi; and not __fish_seen_subcommand_from meta help" -l log-file -d 'Location for log file' -r -F
complete -c probe-rs -n "__fish_probe_rs_using_subcommand mi; and not __fish_seen_subcommand_from meta help" -s r -l report -r -F
complete -c probe-rs -n "__fish_probe_rs_using_subcommand mi; and not __fish_seen_subcommand_from meta help" -l log-to-folder -d 'Enable logging to the default folder. This option is ignored if `--log-file` is specified'
...
complete -c probe-rs -n "__fish_probe_rs_using_subcommand mi; and __fish_seen_subcommand_from meta" -l log-file -d 'Location for log file' -r -F
complete -c probe-rs -n "__fish_probe_rs_using_subcommand mi; and __fish_seen_subcommand_from meta" -s r -l report -r -F
complete -c probe-rs -n "__fish_probe_rs_using_subcommand mi; and __fish_seen_subcommand_from meta" -l log-to-folder -d 'Enable logging to the default folder. This option is ignored if `--log-file` is specified'
